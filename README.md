...
- คอลัมน์ **Version** (มาจาก `rowObj.version` ของแต่ละแพตช์) แสดงเวอร์ชัน ArcGIS ที่แพตช์นั้นตรงกับไฟล์ที่จะดาวน์โหลดจริง — สำคัญเวลาดูที่ **All versions** เพราะ Esri มักออกแพตช์ชื่อเดียวกัน (เช่น "ArcGIS Desktop TLS Patch") ซ้ำหลายแถวสำหรับแต่ละเวอร์ชัน (10.3, 10.3.1, 10.4, ...) โดยที่ Released/Component/Platform/Security เหมือนกันหมด ถ้าไม่มีคอลัมน์นี้ผู้ใช้จะแยกแถวไม่ออกและอาจกดดาวน์โหลดแพตช์ผิดเวอร์ชัน (ปุ่ม Download เองอ้างอิงเวอร์ชันของแถวนั้นถูกต้องอยู่แล้ว ปัญหาเดิมคือ UI ไม่แสดงให้เห็น)
